...
namespace WebApplication1.Data
{
    public static class TestData
    {
        ...
        public static IEnumerable<Section> Sections { get; } = new[]
        {
            ...
            new Section{Id = 8, Name = "ТВОЁ", Order = 0, ParentId = 7},
            new Section{Id = 9, Name = "BOSS", Order = 1, ParentId = 7},
            ...
            new Section{Id = 15, Name = "Дольче и Габана", Order = 7, ParentId = 7},
            ...
            new Section{Id = 19, Name = "8 марта", Order = 0, ParentId = 18},
            new Section{Id = 20, Name = "Guess", Order = 1, ParentId = 18},
            new Section{Id = 21, Name = "Милавица", Order = 2, ParentId = 18},
            new Section{Id = 22, Name = "Marry Key", Order = 3, ParentId = 18},
            new Section{Id = 23, Name = "Oriflame", Order = 4, ParentId = 18},
